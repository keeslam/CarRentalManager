        ...
        <TabsContent value="whatsapp" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure WhatsApp Business integration via Twilio for automated notifications
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Turn on WhatsApp Business integration
                    </p>
                  </div>
                  <Switch
                    id="whatsapp-enabled"
                ...
                <div className="grid gap-4">
                  ...
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">From your Twilio console</p>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-1">Keep this secure - from your Twilio console</p>
                  </div>
                </div>

                <div className="pt-4 border-t">
                  <h3 className="text-sm font-medium mb-4">Automated Notifications</h3>
                  
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
                      <div>
                        <Label htmlFor="whatsapp-auto-notifications" className="text-sm font-medium">
                          Enable Automated Notifications
                        </Label>
                        <p className="text-xs text-muted-foreground">
                          Automatically send WhatsApp messages for events
                        </p>
                      </div>
                      <Switch
                        id="whatsapp-auto-notifications"
                        checked={whatsappAutoNotifications}
                        onCheckedChange={setWhatsappAutoNotifications}
                        data-testid="switch-whatsapp-auto-notifications"
                      />
                    </div>

                    {whatsappAutoNotifications && (
                      <div className="ml-4 space-y-3 pl-4 border-l-2 border-muted">
                        <div className="flex items-center justify-between">
                          <div>
                            <Label htmlFor="whatsapp-notify-reservation" className="text-sm">
                              Reservation Created
                            </Label>
                            <p className="text-xs text-muted-foreground">
                              Send confirmation when new reservation is made
                            </p>
                          </div>
                          <Switch
                            id="whatsapp-notify-reservation"
                            checked={whatsappNotifyOnReservationCreated}
                            onCheckedChange={setWhatsappNotifyOnReservationCreated}
                            data-testid="switch-whatsapp-notify-reservation"
                          />
                        </div>

                        <div className="flex items-center justify-between">
                          <div>
                            <Label htmlFor="whatsapp-notify-pickup" className="text-sm">
                              Pickup Reminder
                            </Label>
                            <p className="text-xs text-muted-foreground">
                              Remind customer 1 day before pickup
                            </p>
                          </div>
                          <Switch
                            id="whatsapp-notify-pickup"
                            checked={whatsappNotifyOnPickupReminder}
                            onCheckedChange={setWhatsappNotifyOnPickupReminder}
                            data-testid="switch-whatsapp-notify-pickup"
                          />
                        </div>

                        <div className="flex items-center justify-between">
                          <div>
                            <Label htmlFor="whatsapp-notify-return" className="text-sm">
                              Return Reminder
                            </Label>
                            <p className="text-xs text-muted-foreground">
                              Remind customer 1 day before return
                            </p>
                          </div>
                          <Switch
                            id="whatsapp-notify-return"
                            checked={whatsappNotifyOnReturnReminder}
                            onCheckedChange={setWhatsappNotifyOnReturnReminder}
                            data-testid="switch-whatsapp-notify-return"
                          />
                        </div>

                        <div className="flex items-center justify-between">
                          <div>
                            <Label htmlFor="whatsapp-notify-payment" className="text-sm">
                              Payment Due
                            </Label>
                            <p className="text-xs text-muted-foreground">
                          ...
                          <Switch
                            id="whatsapp-notify-payment"
                            checked={whatsappNotifyOnPaymentDue}
                            onCheckedChange={setWhatsappNotifyOnPaymentDue}
                            data-testid="switch-whatsapp-notify-payment"
                          />
                        </div>
                      </div>
                    )}
                ...
                <div className="flex gap-2 pt-4">
                  <Button
                    variant="outline"
                    onClick={() => {
                      window.open('/settings/whatsapp/templates', '_blank');
                    }}
                  ...
                  <Button
                    variant="outline"
                    onClick={() => {
                      window.open('/whatsapp/messaging', '_blank');
                    }}
                    data-testid="button-open-messaging"
                  >
                    <MessageCircle className="h-4 w-4 mr-2" />
                    Open Messaging Dashboard
                  </Button>
                </div>
              </div>
